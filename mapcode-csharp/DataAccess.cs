...
namespace mapcode.com
{
    ...
    {
        private static readonly byte[] FILE_DATA = Resources.mminfo;
        ...
        private static int AsUnsignedByte(int i)
        {
            int u = FILE_DATA[i];
            if (u < 0)
            {
        ...
        public static int DataFlags(int i)
        {
            return AsUnsignedByte((i * 20) + 16) + AsUnsignedByte((i * 20) + 17) * 256;
        }

        public static int AsLong(int i)
        {
        ...
        public static int SmartDiv(int i)
        {
            return AsUnsignedByte((i * 20) + 18) + (AsUnsignedByte((i * 20) + 19) * 256);
        }

        private static readonly int[] DATA_START =
        {
...
#region low-level routines for data access

        public static int DataFirstRecord(int ccode)
        {
            return DATA_START[ccode];
        }

        public static int DataLastRecord(int ccode)
        {
